  ...
  return (
    <Formik
      initialValues={{
       ...
       onSubmit={(values) => {
          onOpen('Great!', `Thanks for your submission ${values.name}, we will get back to you soon!`)
      ...
      <Form className='flex flex-col gap-6'>
          ...
          <div 
            ...
            <Field as="textarea" placeholder='Write down your message' className='p-4 border border-slate-300 rounded-lg ' name="message" />
               <div className='text-right text-sm text-red-700' >
